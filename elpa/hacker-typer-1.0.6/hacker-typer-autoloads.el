;;; hacker-typer-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Kill ‘hacker-typer’ buffers." t nil)
...
Delete all data in `hacker-typer-data-dir'." t nil)

(register-definition-prefixes "hacker-typer" '("hacker-typer-"))
